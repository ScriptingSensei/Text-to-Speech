...
def download():
    # Implement the functionality for downloading here
    print("Downloading...")

# icon
image_icon = PhotoImage(file="C:/Users/Asus/Downloads/speak1.png")
...
Logo = PhotoImage(file="C:/Users/Asus/Downloads/speaker logo.png")
...
imageicon = PhotoImage(file="C:/Users/Asus/Downloads/speak1.png")
btn = Button(root, text="Speak", compound=LEFT, image=imageicon, width=130, font="arial 14 bold", command=speaknow)
btn.place(x=550, y=280)

imageicon2 = PhotoImage(file="C:/Users/Asus/Downloads/download (1).png")
